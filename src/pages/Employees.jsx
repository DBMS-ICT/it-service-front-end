...
import EmployeeTables from '../components/employee/EmployeeTables';
...
function Employees() {
  ...
  return (
    <div>
      <Breadcrumb pageName={language === 'en' ? 'Employees' : 'کارمەندانان'} />
              ...
              >
                ...
                >
                  <div className="flex items-center justify-center space-x-3.5">
                    ...
                    {/* <button className="hover:text-danger ease-in-out duration-300">
                      <svg
                        className="fill-current"
                        width="18"
                        height="18"
